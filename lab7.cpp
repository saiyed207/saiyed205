...
point v[4]={{0.0,0.0,1.0},{0.0,0.942809,-0.33333},{-0.816497,-0.471405,-0.333333},
{0.816497,-0.471405,-0.333333}};
int n =2;/*recursive steps*/
...
divide_tetrahedron(a, v1,v2,v3,n-1);/*a tetrahedron formed from vertices a,mid point of
ab,ac,ad edge*/
divide_tetrahedron( v1,b,v4,v6,n-1);/*a tetrahedron formed from vertices b,mid point of
ab,bc,bd edge*/
divide_tetrahedron( v2,v4,c,v5,n-1);/*a tetrahedron formed from vertices c,mid point of
ac,bc,cd edge*/
divide_tetrahedron( v3,v6,v5,d,n-1);/*a tetrahedron formed from vertices d,mid point of
ad,cd,bd edge*/
}
else
